...
Empirical studies such as \citet{donaldson2016railroads} demonstrate the transformative effects of improved market access on land values, trade, and economic activity. \citet{collier2016cost} anaylze the costs and challenges associated with road infrastructure in low- and middle-income countries, emphasizing the need for context-specific investment strategies. \citet{fajgelbaum2020optimal} introduce spatial equilibrium models that allow for the optimal allocation of transport investments, accounting for congestion, returns to infrastructure, and welfare maximization.
