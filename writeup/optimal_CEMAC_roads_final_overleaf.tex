...
\author{Sebastian Krantz\footnote{Kiel Institute for the World Economy and World Bank\\ \hphantom{aaa}\textit{E-mail:} sebastian.krantz@kielinstitut.de or skrantz@worldbank.org.}\ \ and Theophile Bougna\footnote{World Bank\\ \hphantom{aaa}\textit{E-mail:} tbougna@worldbank.org.}}
\begin{document}
\maketitle
...
This paper characterizes optimal road investments in the Economic and Monetary Community of Central Africa (CEMAC). Leveraging high-resolution data on population, wealth, agricultural production, conflict, border frictions, and a detailed transport network graph, we assess both potential and planned projects in the region. Through partial and general equilibrium analyses, we determine market-access and welfare-maximizing investment packages under varying budget scenarios. Our findings reveal that border frictions constitute a critical bottleneck, and reducing trade barriers delivers economic gains comparable to major physical infrastructure upgrades. Optimal road investments should prioritize high-yield corridors connecting major urban centers and agricultural zones—particularly in Cameroon—rather than remote locations. While CEMAC planned flagship projects significantly improve connectivity, they yield lower returns compared to model-derived optimal packages. Maximizing the region's economic potential requires a dual strategy: targeting infrastructure upgrades in high-density areas and implementing trade facilitation reforms to reduce border costs.
%This paper characterizes optimal road investments in the Economic and Monetary Community of Central Africa (CEMAC) using a quantitative spatial framework. Integrating high-resolution data on population, wealth, agricultural production, conflict, and border frictions, we construct a detailed transport network graph to evaluate both potential and planned projects. Through partial and general equilibrium analyses, we identify market-access and welfare-maximizing investment packages under varying budget scenarios. Our findings reveal that border frictions constitute a critical bottleneck; reducing trade barriers yields economic gains comparable to substantial physical infrastructure upgrades. Optimal road investments there while should prioritize high-yield corridors connecting major urban centers and agricultural zones—particularly in Cameroon—over remote connections. Planned regional projects improve connectivity but yield lower returns compared to model-derived optimal packages. Maximizing the region’s economic potential thus requires a dual strategy of targeted infrastructure upgrades in high-density areas and trade facilitation reforms to lower border costs.
\\ [0.7em]
\noindent \textbf{Keywords:} Roads, optimal investments, trade facilitation, CEMAC, regional integration.\\
\textbf{JEL Classification:} R13; R42; O18; F15; H54
\end{abstract}

\newpage
\section{Introduction}

The Economic and Monetary Community of Central Africa (CEMAC) comprises six member states—Cameroon, Central African Republic, Chad, Republic of Congo, Equatorial Guinea, and Gabon—representing a region with significant economic potential but persistent challenges in achieving regional integration, economic diversification, and sustainable development. Transport infrastructure, particularly the road network, has emerged as a critical bottleneck impeding regional growth. Despite substantial investments over recent decades, the region’s road network remains fragmented, border frictions are high, and market access for both people and goods is uneven—especially for landlocked and rural areas \citep{LPI2023,WorldBank2025_CEMAC_InfrastructureSAP}. These constraints have been highlighted in recent strategic assessments, notably the World Bank's CEMAC Regional Infrastructure Sector Assessment (InfraSAP) \citep{WorldBank2025_CEMAC_InfrastructureSAP}, which underscores the need for evidence-based, regionally coordinated investment strategies to unlock the region’s economic potential. \newline 

The importance of transport infrastructure in fostering economic growth and regional integration is well established in the literature. %Early theoretical work by \citet{armington1969theory} and 
Empirical studies such as \citet{donaldson2016railroads} demonstrate the transformative effects of improved market access on land values, trade, and economic activity. \citet{collier2016cost} analyze the costs and challenges associated with road infrastructure in low- and middle-income countries, emphasizing the need for context-specific investment strategies. \citet{fajgelbaum2020optimal} introduce spatial equilibrium models that allow for the optimal allocation of transport investments, accounting for congestion, returns to infrastructure, and welfare maximization.
Recent advances in data availability and modeling techniques have enabled more granular analysis of transport networks. \citet{graff2024spatial} and \citet{krantz2024optimal} leverage high-resolution spatial data, network representations, and general equilibrium analysis to identify investment priorities and quantify welfare gains across Africa. These studies highlight the role of network efficiency, border frictions, and path dependence in shaping economic outcomes. However, much of the existing literature has focused on national or continental scales, with limited attention to the unique institutional, geographic, and economic context of Central Africa. The region’s complex political economy, diverse topography, and history of conflict present additional challenges for infrastructure planning and implementation \citep{raleigh2023political,AfDB2022_AfricanEconomicOutlook}. \newline 

Within CEMAC, border frictions remain a major impediment to regional integration. The World Bank’s Logistics Performance Index \citep{LPI2023} and Doing Business surveys \citep{fontagne2023trade} consistently rank Central African countries among the lowest globally in terms of trade facilitation and border efficiency. Thick borders, inefficient customs procedures, and lack of harmonization in transport regulations contribute to high transaction costs and delays, undermining the competitiveness of regional corridors. The InfraSAP and related policy studies \citep{WorldBank2025_CEMAC_InfrastructureSAP, AfricanUnion2021_AfricanIntegrationReport} emphasize the need for targeted reforms, such as the implementation of one-stop border posts, digitalization of trade documentation, and harmonization of customs procedures. \newline 

In addition to border issues, the allocation of road investments has often been driven by political considerations rather than rigorous economic analysis. As a result, resources are frequently spread thinly across low-impact projects, while high-impact corridors—connecting major urban centers, ports, and productive agricultural zones—remain underdeveloped \citep{collier2016cost, krantz2024optimal}. The literature advocates for the use of quantitative frameworks to guide investment decisions, incorporating market access, welfare gains, and cost-benefit analysis \citep{donaldson2016railroads, fajgelbaum2020optimal, krantz2024optimal, herrera2024shrinking, donaldson2025transport, FajgelbaumGaubert2025Optimal, allen2025evaluating}. Furthermore, the integration of logistics platforms, port efficiency, and multimodal connectivity (including rail and waterways) is increasingly recognized as essential for maximizing the returns on road investments \citep{WorldBank2025_ContainerPortindex, AfDB2022_AfricanPortsconnectivity}. \newline 

Social, environmental, and safety considerations are also gaining prominence in infrastructure planning. The \citet{AfDB2022_AfricanEconomicOutlook} and the recent World Bank report \citet{WorldBank2020_StrengtheningResilience} highlight the importance of mainstreaming road safety audits, climate resilience measures, and social inclusion strategies into transport investments. Targeted interventions to improve access to rural productive centers and urban mobility can strengthen food systems, livelihoods, and private sector development, contributing to more inclusive and sustainable growth. \newline 

This paper contributes to the literature by characterizing optimal road investments in the CEMAC region through a rigorous quantitative framework that integrates updated data on population, wealth, agricultural production, conflict incidence, and border frictions. Building on the methodology of \citet{krantz2024optimal} and the priorities identified in the InfraSAP, we construct a detailed graph representation of the regional road network, evaluate both existing and planned projects—including the Point-Noire–Brazzaville–Bangui–Ndjamena corridor (CD13)—and apply partial and general equilibrium analysis to assess CEMAC market access and welfare-maximizing investments under varying budget and policy scenarios.\newline 

Our findings confirm that reducing border frictions, prioritizing investments in high-impact corridors, and strengthening corridor governance are essential for maximizing the economic and social returns of road investments. The analysis demonstrates that targeted reforms—such as harmonizing customs procedures, implementing one-stop border posts, and integrating logistics platforms—can yield substantial market access gains and foster inclusive growth. Furthermore, the paper highlights the importance of mainstreaming social, environmental, and safety objectives, and of adopting data-driven approaches to project selection and monitoring. \newline 

In light of these results, the paper concludes with actionable policy recommendations for CEMAC policymakers and development partners. These include prioritizing border friction reduction, focusing investments on high-impact corridors, strengthening institutional capacity, integrating logistics and trade facilitation, mainstreaming social and environmental objectives, and promoting systematic monitoring and evaluation. By operationalizing these recommendations, the region can move toward a more connected, resilient, and prosperous future. \newline
...
To build a graph of the CEMAC road network, we start by selecting the largest cities within a 100km radius with a population above 50,000. For this, we use the updated (2024) Africapolis data tracking the populations of 525 agglomerations in CEMAC in 5-year intervals \citep{africapolis2024}. We take the population projection for 2025 and refine the centroid for larger agglomerations, which in Africapolis is the centroid of the built-up area but not necessarily the economic center of a city, with geographically accurate places data from \href{https://public.opendatasoft.com/explore/dataset/geonames-all-cities-with-a-population-500/table/?disjunctive.country}{Geonames}. This yields 54 cities, of which 6 have international ports. According to port outflows in 2020Q1 recorded by the \href{https://datacatalog.worldbank.org/search/dataset/0038118/Global---International-Ports}{World Bank}, Pointe Noire, Kribi and Douala are large ports, and Bata, Libreville and Port Gentil are small ports. \newline 

Following \citet{krantz2024optimal}, we then compute $(54^2-54)/2 = 1431$ fastest car routes between these 54 cities and process them into a network of 196 nodes and 313 edges by simplifying and intersecting routes and clustering the intersection points within a 10km radius, where a gravity weight is applied to choose among intersection points within a cluster.\footnote{"Gravity" measures the expected traffic volume. See the notes of Figure \ref{fig:ROADS} for more details.} Because the OpenStreetMap (OSM) routing engine (OSRM) does not navigate along several smaller roads in the region, sometimes in contrast to Google Maps, we depart from \citet{krantz2024optimal} and use the Graphhopper routing engine instead, which is also OSM-based but has a different car profile, and a different algorithm which we find gives more natural and direct results in the region. After thus constructing the network, we estimate the travel speed of each segment using Google Maps.\footnote{Google Maps could, in theory, also be used directly to create the network, but it does not return exact geometries of routes, which presents problems to our method of intersecting/processing the routes. \vspace{-4mm}}   \newline 

Finally, following \citet{krantz2024optimal}, we apply a network finding algorithm (described in \citet{krantz2024optimal} Section 4.2), parameterized with a $\alpha = 45^\circ$ maximum angle for intercepting nodes, the European route efficiency estimate of 0.767, and removing links with a real route efficiency of 2/3 or higher. The algorithm retains 71 links that reduce travel distance by $\geq$50\%. To account for engineering constraints, these segments are parameterized with a route efficiency of 0.787, or a length 1.27 times their great circle distance---the average across existing links in the region.  % \newline
...
\end{figure}
  ...
  To estimate node productivity, we take an inverse-distance-weighted average of all IWI estimates within 10km of each node (to give more weight to productive city centers). This average ranges from $\sim 65$ IWI points in port cities such as Port-Gentil, Douala, and Libreville to $\sim 10$ in some remote cities such as Baibokoum in Chad. We then multiply it with the node population to measure total wealth and use that to distribute 80\% of the region's real 2023 GDP, amounting to 72.7 billion 2015 USD (total GDP is \$90.9B USD'15), across the 119 populated nodes. \newline 
  
 Additionally, we compute an inverse-distance weighted sum of crop production of the region's 11 most important crops within 50km around each node, where the weight of cell $i$ is $1 - \delta_{i\leq 50km} / 50km$, i.e., 0 for fields 50km or more from the node and 1 for fields at the node. We then use this sum to distribute the remaining 20\% of the region's 2023 GDP, amounting to 18.2 billion 2015 USD, across nodes. This is appropriate as the share of the primary sector in GDP ranges from 2.9\% in Equatorial Guinea to 28.6\% in the Central African Republic, with Cameroon, accounting for 46\% of CEMAC GDP and 45\% of the CEMAC population, at 16.7\%. Figure \ref{fig:GDPNet} summarizes this process.
...
\raggedright
\scriptsize 
\emph{Notes:} Figure shows (inverse-distance weighted) production of top 11 crops within 50km radius nodes (left) and IWI within 10km around nodes times node population (center). Both are combined to distribute GDP across nodes (right). \\ \vspace{-10mm}
\end{figure}
  
We also take into account cross-border frictions following \citet{krantz2024optimal}. Figure \ref{fig:DB_TAB} visualizes them. The top panel shows the raw border compliance cost and time from the 2019 Doing Business Survey, and the bottom panel shows these converted to road distance and travel time, respectively, also taking into account documentary compliance times/costs. Evidently, and as visible in \citet{krantz2024optimal} Figures 6 and 7, border costs are high in the region, with a median cost of \$2272 and time of 411 hours, compared to the African median cost of \$1222 and time of 224 hours. 
...
Similarly, we can consider total market access (MA) implied by the network, where the MA of node $i$ is the sum of the estimated GDPs of all other nodes $j$ divided by their respective road distance along the fastest $i\to j$ route. The total network MA is then the sum of MA across all nodes. The total network MA is 28.3 billion USD'15 per km. Building all proposed links increases MA by 5\%. Using 2019 estimates of cross-border frictions from the final edition of the World Bank Doing Business surveys and translating documentary and border compliance time/cost into road time/distance, respectively, following \citet{krantz2024optimal}, reduces total MA to 19.6 billion USD'15 per km or 31\% smaller. The MA gain from all proposed links reduces to 3\%. Figure \ref{fig:MA_DA_TAN} shows the total MA gains from building each link with and without frictions and their ratio. Clearly, frictions reduce the value of new border-crossing links. The marginal gains from all links are lower under frictions as long as the route is fixed and transiting is less costly. %\citet{krantz2024optimal} discusses other cases where traders can adjust their multi-country routes to minimize border costs, which I refrain from here as the CEMAC region is small. 
Following \citet{krantz2024optimal}, we assume a 48h transit cost (24h per border) for transiting through 3rd countries.\footnote{This assumption, while crude, does not impact the results much as faraway cities ($j$) contribute little to MA$_i$.} %, the focus should not be on the impact of border frictions except to make it clear that they should be removed as much as possible. 
...
Apart from new construction, upgrading roads is vital in a region characterized by slow travel speeds. The median link speed, taken from Google Maps without traffic awareness,\footnote{Apart from practical difficulties measuring congested speeds in a representative way, recent work by \citet{NBERw31642} shows that uncongested speeds account for more than 90\% of the global variation in urban travel speeds.\vspace{-3mm}} is 60km/h, ranging from 6.2km/h for the slow ferry connection from Libreville to Port-Gentil, to 103km/h on the highway from Bata to Mongomo in Equatorial Guinea. Figure \ref{fig:ALS} shows the speed of each link. 
...
\raggedright
\scriptsize 
\emph{Notes:} Figure shows total MA gains measured (summed) across all trips from upgrading a link to allow speeds $\geq$90km/h. % \\ % \vspace{-2mm}
 \vspace{-2mm}
\end{figure}

Evidently, upgrading links in the populated areas of Cameroon, by far the largest economy among the six, yields the greatest MA returns, especially under border frictions. Without frictions, better connecting the economic center of Cameroon up north and east also yields high MA gains.  

\subsection{Border Post Optimization}

We also simulate the effect of reducing the border cost at specific borders, measuring the change in total MA, taking into account traders' decisions to take the fastest route. Following \citet{fontagne2023trade}, we consider a 50\% border cost/time reduction, gauged to be the effect of replacing a traditional border post with a one-stop border post. However, the region's median road-time equivalent border cost is 127h, which is very high even in African comparison where the median is 76h, coming as low as 5h for the Namibia-Botswana and Mozambique-Eswatini borders. Thus, we also consider a scenario where the border cost is reduced to 12h regardless of the original cost, amounting to a $\sim$90\% reduction from the regional median. For reference, we also consider a 100\% reduction where the respective border cost is set to zero. Figure \ref{fig:UG_bpopt} reports the results.
...
\\\vspace{-2mm}
\scriptsize 
\emph{Notes:} Figure shows the marginal MA gain from reducing border costs along on individual border-crossing links. \\\vspace{-8mm}
\end{figure}
...
\end{equation}
In line with \citet{collier2016cost}'s treatment of continuous variables, we take the natural log of $\Omega_j$, and find that it ranges between 0 and 7.5, with a median of 2.84. Since \citet{collier2016cost}'s dummy coefficient is 0.3, we assign a coefficient of $0.3/2.84\approx 0.1$. Our road cost equation is thus
...
Figure \ref{fig:RUGG_POP} shows on the LHS ruggedness from \citet{nunn2012ruggedness} and WorldPop 2020 population density; both are estimated within a 3km two-sided buffer around existing and new links. Notably, the area around Bamenda in Cameroon and further north along the Cameroon-Nigeria border is very rugged. This area is also conflict prone---Appendix Figure \ref{fig:ACLED} shows ACLED conflict event data \citep{raleigh2023political} and the RHS of Figure \ref{fig:RUGG_POP} aggregates it around each link following Equation \ref{eq:conf}. %\citet{collier2016cost}'s road cost prediction model also includes a conflict variable suggesting that costs rise by 20\% during times of violence, but this is not considered in Eq. \ref{eq:COST}. 
...
Following \citet{krantz2024optimal}, we compute link-level cost-benefit ratios as the gain in MA divided by the cost, yielding estimates denominated in \$/min/\$ or 'dollar per minute per dollar invested.' The economic value of such a metric depends on how increases in MA translate into increases in economic activity. \citet{krantz2024optimal} estimates a long-run elasticity of GDP to MA in Africa of around 0.33, suggesting that in Africa MA translates into GDP at a rate of 3:1. This finding is consistent with \citet{donaldson2016railroads}'s estimates of a 0.5 elasticity of changes in US land values between 1870 and 1890 to a railroad-induced increases in MA. However, readers should note, particularly in comparison with \citet{krantz2024optimal}, that the focus on the CEMAC region alone yields smaller estimates of MA gains from road projects because locations outside of CEMAC which could benefit from them, including traders transiting through CEMAC, are not considered. \newline 

The average gain from upgrading existing links to allow speeds of 90km/h is 0.85\$/min/\$. This drops to 0.47\$/min/\$ under border frictions. In either case, \citet{krantz2024optimal} and \citet{donaldson2016railroads}'s finding would imply that economic gains are at max half of that; thus, upgrading all links is not sensible. Only 17.5\% of links have gains above 2\$/min/\$ without frictions, indicating medium-term profitability. With frictions, only 7.6\% have gains above 2\$/min/\$. \newline 
...
Since building expensive new links lowers the returns to this package and may not be the policymakers' intention, we also consider the same package without new links on the RHS of Figure \ref{fig:UG_cons}. It then would cost only 4 billion USD'15 and yield a 44\% frictionless MA gain, amounting to 11.2 billion USD'15/min or 2.8\$/min/\$. Under frictions, the MA gain would drop to 7 billion USD'15/min or 1.7\$/min/\$. \newline 
...
A final cost-benefit assessment regards macroeconomic feasibility in present-discounted-value (PDV) terms. Here, we also follow \citet{krantz2024optimal} and consider the minimum increase in the macroeconomic growth rate from each package necessary to break even after 30 years, discounting the future by 10\%. As mentioned, CEMAC's GDP in 2023 was 90.1 billion in 2015 USD. Its growth rate between 2003 and 2023 was 3.5\% on average, and the IMF projects a growth of 3.8\% from 2024-2029. Thus, we take a 3.5\% baseline growth rate as the realistic scenario, but also simulate a 2\% growth rate as a pessimistic scenario. Table \ref{tab:MACAB} reports the increases in the macroeconomic growth rate of the region necessary for road projects to break even after 30 years. 
...
The previous section yielded important insights into optimal investments into the regional CEMAC road network using a minimal set of assumptions. However, it could not answer the important policy question of how to optimally spend a fixed budget on the network. The MA-maximization objective also falls short of a benevolent social planners motivation to maximize welfare. To answer these questions, we need to impose additional structure and will do so using the quantitative framework of \citet{fajgelbaum2020optimal}, again closely following \citet{krantz2024optimal} and \citet{graff2024spatial}. %, utilizing and some parameters taken from \citet{graff2024spatial}. 


\subsection{Model}

We assume the CEMAC economy consists of a set of locations $j \in \mathcal{J}$ connected by a transport network. Preferences of a representative worker in location $j$ are given by a normalized inequality-averse Cobb-Douglas utility function over consumption $c_j$ and housing $h_j$
\begin{equation}
...
\end{equation}
where $\delta^\tau_{jk}$ is a link-specific constant depending on distance. The parameter $\beta$ captures congestion forces, while $\gamma$ captures returns to infrastructure. In the CEMAC application, $I_{jk}$ is measured in km/h as the average travel speed along link $j\to k$ and can be increased at a cost $\delta^I_{jk}$ proportional to the per-km construction or upgrading cost implied by Eq. \ref{eq:COST}: $\delta^I_{jk} = (\frac{\text{cost}}{\text{km}})_{jk} / (I^\text{max}_{jk} - I_{jk})$ where $I^\text{max}_{jk}$ is set to 90 km/h. A social planner with budget $B$ chooses infrastructure levels $I_{jk}^*$, subject to staying between current speeds and $I^\text{max}_{jk}$, to maximize the population-weighted average of $u_j$, respecting the model's equilibrium conditions. Solving the model yields that equilibrium trade flows of good $n$ are $Q^n_{jk} = I_{jk}^{\frac{\gamma}{\beta}}\Psi^n_{jk}$, where $\Psi^n_{jk}$ is a function of parameters and prices $P^n_{jk}$. \citet{fajgelbaum2020optimal} further develop this by substituting out $Q^n_{jk}$ such that optimal investments in $I_{jk}^*$ become a function of parameters and prices. In practice, the problem is solved iteratively by first solving $Q^n_{jk}$ and then incrementing $I_{jk}$ until convergence subject to the model's constraints. We refer the reader to \citet{fajgelbaum2020optimal} and MATLAB/Julia codes on \href{https://github.com/OptimalTransportNetworks}{GitHub} for details.

\subsection{Calibration}

Following \citet{graff2024spatial}, we set the consumption share in utility $\alpha = 0.7$, congestion parameter $\beta = 1.177$, and returns to infrastructure $\gamma = 0.946$. As in \citet{krantz2024optimal}, we let ports produce the imports. Since the region also has land borders, we apply the same scaling factor to the ports' export volume (in 2020 Q1) obtained considering imports and ports of the entire continent. This yields imports through the region's 6 ports of 16.9\% of CEMAC GDP. Imports of goods and services in 2019-2023 were 28.2\% of CEMAC GDP, and merchandise imports were 19.2\%, so 16.9\% implies that the bulk of merchandise imports is assumed to enter via the region's 6 international ports.  \newline 

To create incentives for trade through the network, we let 16 cities with populations $>$200,000 or ports with outflows of $>$1M TEU in 2020 Q1 produce their own product. The remaining cities are classified into port (positive outflows), large city with population $>$ 100,000, medium-sized city with population $>$50,000, and town/unpopulated node otherwise. The nodes are parameterized with total productivity ($=$ GDP/population) and population. Port cities have additional international productivity to produce 16.9\% of GDP worth of imports.\footnote{Amounting to $(\text{outflows [TEU] in 2020 Q1}\times 2100)/\text{population}$, where the factor of 2100 is a translation of the factor of 37 from \citet{krantz2024optimal} based on the IWI to the GDP scale.\vspace{-2mm}} Edges are parameterized with speed in km/h; infrastructure building cost, iceberg trade cost, and (optionally) border frictions---excatly following \citet{krantz2024optimal} except for Eq. \ref{eq:COST}. Figure \ref{fig:Graph_Calib} shows the classified and parameterized graph. % \newline 
...
We set the elasticity of substitution equal to $\sigma = 3.8$ following \citet{bajzik2020estimating} and \citet{armington1969theory} because this setting resembles products differentiated by origin traded in an international context. We simulate cases with ($\rho = 2$) or without ($\rho = 0$) inequality aversion and border frictions, as well as with or without new links, for planning budgets of 1, 2, and 4 billion USD'15, which is about 1.19, 2.38, and 4.76 billion in current USD, respectively. The Appendix additionally reports results for a 5 billion budget. We also consider the case of increasing returns to infrastructure ($\gamma^* > \beta$, default is $\gamma < \beta$) with $\gamma^* = \beta^2/\gamma$, i.e., inverting the ratio of $\beta$ (congestion) and $\gamma$ (returns to infrastructure) keeping $\beta$ fixed as in \citet{fajgelbaum2020optimal}. As mentioned, upgrading all links to $\geq$90km/h would cost 19 billion USD'15, and constructing all proposed links would cost 8 billion USD'15. We start with scenarios where planners can only upgrade existing links. 

\subsection{Upgrading Roads} 

Figure \ref{fig:GE_UGNOfr} shows the results, in terms of the fraction of the link upgraded, from planners optimally spending 1, 2, or 4 billion USD’15 on upgrading the network without frictions. Clearly, these planners focus on better connecting the central populated regions, particularly in central Cameroon and at the Cameroon-Chad border area. But also the roads between Point-Noire and Brazzaville and between Bangui and Mbaiki and from Ouesso into Cameroon are upgraded. \newline %All planners also upgrade the slow ferry connection between Libreville and Port-Gentil, implying that building a road connecting the two has high priority. 

With inequality aversion, planners spend a bit more in poorer northern Chad and less in the richer coastal regions. Since with upgrading the network structure is fixed, increasing returns (IRS) only has a minor impact on the optimal allocation. More notable is that the generated trade flows (visualized for selected cities and the \$2B budget case in Appendix Figure \ref{fig:GE_UGNOfrFL}) and also the total welfare gain (WG) is significantly higher in the IRS case. This is because equilibrium trade flows are $Q^n_{jk} = I_{jk}^{\frac{\gamma}{\beta}}\Psi^n_{jk}$. Higher flows imply a more diverse CES consumption basket, giving higher utility, and a larger $\gamma$ (larger $\gamma/\beta$ ratio) implies greater sensitivity to changes in $I_{jk}$. % \newline 

Precisely estimating $\beta$ and $\gamma$ as well as the elasticity of substitution $\sigma$ would be necessary for accurate welfare assessments, thus reported gains need to be treated with caution. Fortunately, except for lowering $\sigma$ a lot, infrastructure allocations are not very sensitive to these parameters. It is notable that inequality aversion ($\rho = 2$) yields slightly lower aggregate welfare gains (e.g., 0.9\% instead of 1\% in the \$4B investment case) in favor of a more equitable distribution of gains. \newline 

We also run the simulations with border frictions. Appendix Figure \ref{fig:GE_UGFR} reports the difference to the frictionless case. As in \citet{krantz2024optimal}, frictions lead to slight alterations in the optimal allocation away from expensive border-crossing links. In some cases, other border-crossing links are strengthened instead, and funds are directed to building more domestic links. Overall, the effects of frictions are minor, presumably because they enter iceberg trade costs through a log function (see \citet{krantz2024optimal} Eq. 10), and non-trivial as the resulting reallocations are a GE outcome. \newline 
...
\section{Evaluating CEMAC Regional Road Projects}

Detailed engineering expertise and CBA guided the design and planning of regional road projects. However, such efforts often overlook critical socioeconomic dimensions, as well as the potential for projects to generate broader economic benefits. This omission can result in economically suboptimal investments. 
To investigate this, the final section of this paper jointly evaluates several major road projects in the region—including key corridors such as the CD13 project—using the economic frameworks developied in this paper. This approach enables a comprehensive assessment of market-access gains, welfare impacts, and cost-effectiveness, ensuring that future investment decisions align with both engineering design, technical feasibility, and economic optimization. \newline 

%Detailed engineering knowledge was applied in the design and planning of CEMAC road and flagship projects. Failing to account for social, economic dimensions and the potential for the project to generate wider economic benefits while designing a corridor project %However, these considerations may have insufficiently accounted for the potential economic gains and may lead to economically suboptimal investments or likely to financially not break even in the medium run. To investigate this, this final section jointly evaluates several road projects in the region--including , and major corridor developed includes the CD13 project-- using the economic modeling framework developed in this paper.   
...
\multicolumn{3}{c}{\textbf{Increasing Returns to Infrastructure} ($\gamma^* = \beta^2/\gamma$)} \\ [0.5em]
...
Figure \ref{fig:MA_TT_PP} shows the marginal MA gains for all targeted links in the region, including gains per USD invested. In total, the projects include 6790km of planned road construction/upgrades, and their costs add up to a sum of 3.4 billion 2015 USD in our calculations following Eq. \ref{eq:COST}. They jointly yield a 28.6\% MA gain (2.14\$/min/\$), which is larger than the sum of individual marginal gains at 23.4\%, indicating that the projects jointly manage to divert more traffic along more optimal routes. Under frictions, the MA gain is 26.7\% (1.17\$/min/\$), and the sum of individual MA gains amounts to 23.2\%. Evidently, these planned projects include both high- and low-yield links, primarily aimed at connecting the major cities of Douala, Bangui, Brazzaville, and N'Djamena. 
...
At last, repeating the reverse-PDV calculation from Table \ref{tab:MACAB} yields that the planned projects would be jointly profitable in PDV terms if they raise the macroeconomic growth rate by 0.74\% in the 3.5\% baseline growth scenario or by 1.62\% in the 2\% baseline growth scenario. Given the 26-29\% MA gains generated, they should be macroeconomically feasible under mild assumptions. \newline 

Overall, we find that planned road projects in the region are decently efficient in both MA and welfare terms and substrantially improve regional connectivty, particularly between major cities Douala, Yaounde, Bangui, Brazzaville, and N'Djamena. They can be improved, however, by reallocating some investments, particularly those around Bangui, to populated and crop regions in Cameroon, yielding up to 50\% higher MA gains in the frictionless case. \newline 

\section{Conclusion and Policy Recommendations} 


This study applies a rich quantitative methodology introduced by \citet{krantz2024optimal} to the CEMAC region, providing a comprehensive assessment of regional road network conditions and optimal road investments, and examining their potential to transform regional connectivity, market access, and economic welfare. The analysis, grounded in both partial and general equilibrium approaches, reveals several critical insights for policymakers, practitioners, and development partners.  \newline
...
First and foremost, border frictions emerge as a dominant constraint to regional integration and economic growth. The simulations demonstrate that eliminating border controls and harmonizing trade regulations could increase travel time-denominated market access (MA) by 58\% and distance-denominated MA by 44\%. These gains are comparable to, and in some cases exceed, those achievable through large-scale infrastructure upgrades. For instance, upgrading all roads to 90 km/h yields a 64\% MA gain at a cost of \$19 billion (2015 USD), while combining upgrades with targeted new links can further boost MA gains to 72\%. These findings reinforce the conclusions of recent policy research, which emphasize the importance of trade facilitation and regulatory harmonization in unlocking the full potential of regional corridors \citep{fontagne2023trade, LPI2023, WorldBank2025_CEMAC_InfrastructureSAP}.  \newline
...
The strategic significance of Cameroon within CEMAC is particularly noteworthy. As the region's largest economy, accounting for 46\% of GDP and 45\% of population, interventions at Cameroon's borders—especially Garoua-Boulai—offer outsized returns. A 50\% reduction in border frictions at this crossing could raise MA by 1.8\%, and a 90\% reduction could yield gains of up to 8.1\%. These results align with broader evidence from the World Bank's Logistics Performance Index and Doing Business surveys, which consistently identify border efficiency as a key determinant of trade competitiveness in Central Africa \citep{LPI2023, fontagne2023trade}.  \newline

%Of particular significance are borders into Cameroon, which is the region's largest economy at 46\% of CEMAC GDP and 45\% of CEMAC population. Which border post to focus on depends on the navigational properties of the network. Our simulations yield that reducing the border at Garoua-Boulai (CMR) would yield the highest MA gains. According to the 2019 business survey and \citet{krantz2024optimal}, borders between Cameroon and CAR have an average cost equivalent to 1592km of road distance or 112h of road time. A 50\% reduction of the border at Garoua-Boulai, considering traders' optimizing behavior, would yield a 1.8\% increase in the region's MA. Reducing the border by 90\% to 12h road equivalent could raise MA by as much as 8.1\%. \newline  

Beyond border reforms, the study highlights the need to upgrade slow and inefficient road links, particularly those serving densely populated and economically vital areas such as Douala, Yaounde, Brazzaville, Pointe-Noire, and N'Djamena. Investments in new links to improve connectivity—especially between Equatorial Guinea (Bata, Kiribi, Libreville) and Gabon (Libreville, Port-Gentil)—can further enhance network efficiency and regional welfare. The analysis shows that investment packages targeting high-yield links (\$4--\$5 billion, 2015 USD) can deliver 43--53\% MA gains and are likely to be profitable over a 30-year horizon, requiring only modest increases in macroeconomic growth rates. These results are consistent with the findings of \citet{krantz2024optimal}. % \citet{collier2016cost} and \citet{graff2024spatial}, who advocate for data-driven investment prioritization based on market access and welfare metrics. 
\newline
...
Comparative analysis of planned projects, such as the CD13 corridor, reveals that while these initiatives improve connectivity to remote regions, their economic returns are somewhat lower than those of optimally selected packages. Planned road projects in the region, such as CD13, are estimated to cost \$3.4B USD'15 and yield 27-29\% MA gains (1.2-2.1\$/min/\$). Compared to gains of 1.4-2.8\$/min/\$ for the \$4B-\$5B partial equilibrium packages, these are modestly economically suboptimal but manage to better connect some remote regions around Bangui in the Central African Republic. Road investments in Cameroon (Douala-Yaounde and up north toward N'Djamena) and in borders crossing to Cameroon yield greatest marginal benefits. Optimal investments stipulate more connectivity improvements around populated and agricultural areas, particularly in Cameroon, but also up north towards N'Djamena and between the coastal cities. These are of higher value as more people benefit from them than long-distance roads in remote areas. The results suggest that prioritizing investments in corridors serving larger populations and productive zones yields greater aggregate benefits, supporting the recommendations of the CEMAC InfraSAP and related policy studies \citep{WorldBank2025_CEMAC_InfrastructureSAP, AfricanUnion2021_AfricanIntegrationReport}.\newline 

A notable methodological insight from this study is the dependence of optimal general equilibrium investment allocations on assumptions about congestion forces. Under standard decreasing returns (strong congestion), planners allocate over 70\% of budgets to constructing new links, despite higher costs. In contrast, for the continent as a whole, upgrading dominates investment allocation. Under increasing returns (weak congestion), the focus shifts to upgrading existing infrastructure, with new construction limited to strategic coastal connections. This highlights the need for more precise estimation of congestion parameters for inter-city transport in Africa, as current evidence is largely limited to urban contexts \citep{graff2024spatial, fajgelbaum2020optimal}. Recent evidence by \citet{NBERw31642} however suggests that, even inside cities, congestion is not a large determinant of travel speeds across countries, and it becomes less important as trip length increases. This suggests that weak congestion and increasing returns to infrastructure (IRS) may be the more sensible modeling assumption in our context. Future research should seek to refine these estimates using empirical data from inter-city corridors.  \newline
...
In summary, this paper demonstrates that a combination of border friction reduction, targeted upgrades, and strategic new links can substantially improve MA and welfare in the CEMAC region. Our findings, in conjunction with the CEMAC Regional Infrastructure Assessment (InfraSAP) and the broader literature on transport infrastructure and regional integration, inform the following policy recommendations to maximize the developmental impact of road investments and advance regional integration, economic diversification and sustainable development in Central Africa. \newline 

Reducing border compliance costs and times should be a central pillar of CEMAC’s regional integration strategy. Empirical evidence demonstrates that thick borders and inefficient customs procedures significantly constrain MA and trade flows \citep{LPI2023, fontagne2023trade}. Policymakers should prioritize the harmonization of customs procedures, the implementation of one-stop border posts at key crossings (e.g., Garoua-Boulai, Kye-Ossi), and the digitalization of trade documentation. These reforms are expected to yield substantial MA gains and unlock the economic potential of regional corridors \citep{Kunaka2025TransportConnectivity, herrera2024shrinking}. \newline 

Investment prioritization should be grounded in quantitative analysis of MA and welfare gains, as advocated by \citet{FajgelbaumGaubert2025Optimal} and \citep{krantz2024optimal}. Upgrading and constructing road links in densely populated areas, major ports, and high agricultural productivity zones should be prioritized. The establishment of transparent selectivity criteria will ensure that resources are allocated to projects with the highest economic and social returns. Road investments should be complemented by improvements in logistics platforms, port efficiency, and multimodal connectivity (including rail and waterways), in line with best practices in corridor development \citep{WorldBank2025_ContainerPortindex}. Developing a CEMAC regional logistics map and sharing data on missing or undeveloped corridors will facilitate gap identification and coordinated action among stakeholders.  
Transport investments should systematically incorporate road safety audits, climate resilience measures, and social inclusion strategies from the outset \citep{AfDB2022_AfricanEconomicOutlook}. Targeted interventions to improve access to rural productive centers and urban mobility will strengthen food systems, livelihoods, and private sector development across CEMAC. \newline 

Effective corridor governance is essential for realizing the benefits of improved MA and reduced border frictions \citep{LPI2023, herrera2024shrinking, WorldBank2023_CEMAC_InfrastructureSAP}. Regional and national authorities should establish or reinforce institutions such as a CEMAC Transport Observatory to monitor corridor performance, harmonize road asset management practices, and standardize legal frameworks. Sustainable funding mechanisms—including public-private partnerships and road user charges—are critical for long-term maintenance and operational efficiency. % \citep{collier2016cost}.  
\newline

The successful implementation of these recommendations requires coordinated action within organizations and across CEMAC member states, supported by technical and development partners. Operationalizing these policy actions will ensure that road investments deliver transformative impacts—enhancing connectivity, reducing trade costs, and fostering inclusive, sustainable growth throughout Central Africa.
...
\begin{figure}[H] \vspace{-1mm}
\centering
\caption{\label{fig:ACLED} ACLED Armed Conflict Events 2018-2024}
\vspace{2mm}
...
\resizebox{\textwidth}{!}{
\begin{tabular}{@{}c@{}c@{}c@{}} 
\textbf{Standard Planner} & \textbf{IA Planner} ($\rho = 2$) & \textbf{IRS Planner} ($\gamma^* = \beta^2/\gamma$) \\
...
\textbf{Increasing Returns to Infrastructure} ($\gamma^* = \beta^2/\gamma$) \\
