...
This paper applies a quantitative spatial framework to identify and characterize optimal road investments in the Economic and Monetary Community of Central Africa (CEMAC). Leveraging high-resolution data on population, wealth, agricultural production, conflict, and border frictions, we construct a detailed transport network graph to assess both potential and planned projects in the region. Through partial and general equilibrium analyses, we determine market-access and welfare-maximizing investment packages under varying budget scenarios. Our findings reveal that border frictions constitute a critical bottleneck and reducing trade barriers delivers economic gains comparable to major physical infrastructure upgrades. The paper also shows that optimal road investments should prioritize high-yield corridors connecting major urban centers and agricultural zones—particularly in Cameroon—rather than remote locations. While CEMAC planned flagship projects improve connectivity, they yield lower returns compared to model-derived optimal packages. Maximizing regional economic potential in CEMAC requires a dual strategy consisting of targeting infrastructure upgrades in high-density areas combined with trade facilitation reforms to reduce border costs.
